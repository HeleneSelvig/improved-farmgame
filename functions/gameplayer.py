...
def gameplayer():
    ...
    def collisionPugHonsehus(pug, honsehus):
        ...
        ny_rect = pg.Rect(pug.x + pug.vx, pug.y + pug.vy,
                          pug.size * pug.scale, pug.size * pug.scale)
    ...
    def collisionLynChickPug(lyn, chick, pug):
        ...
        ny_rect2 = pg.Rect(chick.x + chick.vx, chick.y + chick.vy,
                           chick.size * chick.scale, chick.size * chick.scale)
